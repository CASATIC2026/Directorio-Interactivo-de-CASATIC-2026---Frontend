...
const translations = {
  ...
  en: {
    welcome_msg: 'WELCOME!',
    subtitle: 'Access for Administrators, Partners and Users',
...
export default function LoginPage() {
  ...
  return (
    <div
      dir={t.dir}
      className="min-h-screen flex items-center justify-center bg-[#0E3877] relative px-4 sm:px-6"
