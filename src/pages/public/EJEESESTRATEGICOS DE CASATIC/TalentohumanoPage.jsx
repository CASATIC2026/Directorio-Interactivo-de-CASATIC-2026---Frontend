...
export default function TalentohumanoPage() {
  const features = [
   {description: 'El comité de innovación y tecnología de CASATIC, tiene como finalidad el acompañamiento y realización de iniciativas transversales a los ejes de estratégicos que fortalezcan la capacidad de innovación en el uso, apropiación y desarrollo de las TIC para impulsar el desarrollo económico, social y cultural de nuestro país.' },
       ...
       <section className="relative overflow-hidden bg-gradient-to-br from-casatic-700 via-casatic-800 to-surface-900 py-1 sm:py-1">
         ...
         <div className="absolute -bottom-32 -left-32 w-80 h-80 bg-accent-500/10 rounded-full blur-3xl pointer-events-none" />
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-4 animate-fade-in-up">
            Innovación y <span className="text-gradient-accent">Desarrollo</span>
          </h1>
